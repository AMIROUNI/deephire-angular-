...
@Component({
  selector: 'app-courbeutilisateursconnecte',
  standalone: false,
  templateUrl: './courbeutilisateursconnecte.component.html',
  styleUrl: './courbeutilisateursconnecte.component.css'
})
export class CourbeutilisateursconnecteComponent {
