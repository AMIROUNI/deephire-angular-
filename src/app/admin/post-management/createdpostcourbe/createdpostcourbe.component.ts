...
@Component({
  selector: 'app-createdpostcourbe',
  standalone: false,
  templateUrl: './createdpostcourbe.component.html',
  styleUrl: './createdpostcourbe.component.css'
})
export class CreatedpostcourbeComponent {
