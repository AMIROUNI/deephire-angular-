...
@Component({
  selector: 'app-job-posting-ac',
  standalone: false,
  templateUrl: './job-posting-ac.component.html',
  styleUrl: './job-posting-ac.component.css'
})
export class JobPostingAcComponent implements OnInit {
  ...
  loadData() {
    ...
    this.adminCompanyDashboardService.getJobPostingsPerMonth().subscribe({
      next: (data: number[]) => {
